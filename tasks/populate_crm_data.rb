...
def validate_user_data_against_crm(server,credential,identity,username)      
  ...
  password = get_user_password('vishal.bardoloi')
  ...
  contacts_on_device = RedisUtil.get_md('Contact', 'vishal.bardoloi')
  ...
  opps_on_device = RedisUtil.get_md('Opportunity', 'vishal.bardoloi')
  ...
  # puts ""
  # puts RedisUtil.get_client_attributes('vishal.bardoloi')

class AppInfo < SourceAdapter
  ...
  def query(params=nil)
    ...
    @result = { "1" => { :min_required_version => mrv, :apple_upgrade_url => apple_force_upgrade_url, :android_upgrade_url => android_force_upgrade_url, :mobile_crypt_key => mobile_crypt_key } }
    ...
    #                      :another_new_thing => 'another_new_thing',
